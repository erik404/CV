...
%---------------------------------------------------------
  \cventry
    {Founder \& Lead Software Engineer - [PHP, Symfony4, MySQL, Doctrine2, Git, Docker]} % Job title
...
%---------------------------------------------------------
  \cventry
    {Founder \& Software Engineer \& Project Manager} % Job title
...
%---------------------------------------------------------
  \cventry
    {Developer \& DevOps - [PHP, Symfony4, MySQL, Doctrine2, Drupal, Gitlab, Docker]} % Job title
    {Immer} % Organization
    {Rotterdam, The Netherlands} % Location
...
%---------------------------------------------------------
  \cventry
    {Software Engineer - [PHP, Symfony3/4, MySQL, Doctrine2, REST, Git, Docker]} % Job title
    {Alphacomm B.V.} % Organization
    {Rotterdam, The Netherlands} % Location
...
%---------------------------------------------------------
  \cventry
    {Lead Software Engineer - [PHP, Symfony3/4, MySQL, Doctrine2, REST, SOAP, AS2/4 prot, DDD, RssBus, Git, Docker]} % Job title
    {Energy Global B.V.} % Organization
    {Rotterdam, The Netherlands} % Location
    {May. 2017 - Dec. 2018} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
...
%---------------------------------------------------------
  \cventry
    {Software Engineer (freelance) - [PHP, Laravel, REST, Git, MooTools, MySQL]} % Job title
...
%---------------------------------------------------------
  \cventry
    {Senior Software Engineer - [PHP, Kohana, Drupal, jQuery, MooTools, LESS, SASS, Git, MySQL, ElasticSearch]} % Job title
    {DPDK} % Organization
    {Rotterdam, The Netherlands} % Location
...
%---------------------------------------------------------
  \cventry
    {Software Engineer (freelance) - [Apache Cordova / PhoneGap]} % Job title
...
%---------------------------------------------------------
  \cventry
    {Software Engineer - [PHP, Kohana, jQuery, MooTools, Apache Cordova / PhoneGap, MySQL, Git]} % Job title
...
%---------------------------------------------------------
  \cventry
    {Software/Sharepoint Engineer - [SharePoint 2007/2010, NinTex, C\#, .NET, JavaScript, CVS, MSSQL]} % Job title
    {Workstreampeople} % Organization
